                ...
                <div class="modal-body">
                    ...
                    <div class="ms_save_email">
                        ...
                        <div class="save_input_group">
                            <input type="text" name="phone" placeholder="Enter Your Name" class="form-control">
                        </div>
                        <div class="save_input_group">
                            <input type="password" name="password" placeholder="Enter Password" class="form-control">
                        </div>
                        <button class="save_btn">connexion</button>
                    </div>
                    <div class="ms_dnt_have">
                        <span>pas de compte ?</span>
                        <a href="javascript:;" class="hideCurrentModel" data-toggle="modal" data-target="#myModal">s'inscrire</a>
                    </div>
                </div>
            </div>
        </div>
